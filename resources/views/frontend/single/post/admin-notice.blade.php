  	 ...
  	 <table class="table table-bordered table-hover" id="example" width="100%">
                ...
                <tbody>
                   ...
                   <td>
                      ...
                      <td><a style="color:blue" href="{{ asset('upload/postfile/'.$post->post_file) }}"><i  class="fa fa-file-pdf-o" style="color:red;font-size:20px;margin-right: 5px;"></i>ডাউনলোড</a>
