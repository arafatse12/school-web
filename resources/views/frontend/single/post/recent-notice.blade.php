...
<div id="contents" class="sixteen columns">
	...
	<h2 style="font-weight: bold;font-size:25px"> সাম্প্রতিক নোটিশ </h2>
  	 ...
  	 <table class="table table-bordered table-hover" id="example" width="100%">
                ...
                <tbody>
                   ...
                   <td>
                      ...
                      <td><a style="color:blue" href="{{ asset('upload/postfile/'.$post->post_file) }}">ডাউনলোড</a>
