            ...
            <div class="panel-header " style="background-color: #605ca8;color: white;padding: 10px">My Profile</div>
              <div class="panel-body box-profile" style="margin: 20px">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle" src="{{(!empty($user->image))?url('upload/studentimage/'.$user->image):url('upload/userimage.png')}}" alt="User profile picture">
                </div>
                    ...
                    <!-- The timeline -->
                     <form class="form-horizontal" method="POST" action="{{ route('student.profiles.update') }} " enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <img id="showimage" src="{{(!empty($user->image))?url('upload/studentimage/'.$user->image):url('upload/userimage.png')}}"
