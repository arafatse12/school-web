          ...
          @endif
            ...
            <tr>
                    ...
                    @endif
                      ...
                      <td>
                         {{-- @if($user->status==1)
                          <a href="{{route('admin.student.inactive',$user->id)}}" class="btn  btn-warning btn-xs mr-2"> <i class="fa fa-arrow-up"></i></a>
                          @else
                          <a href="{{route('admin.student.active',$user->id)}}" class="btn btn-success btn-xs mr-2" > <i class="fa fa-arrow-down"></i></a>
                          @endif --}}
